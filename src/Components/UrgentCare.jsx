...
import Urgent_one from '../images/urgent-care-1.jpg'
import urgent_two from '../images/urgent-care-2.webp'
...
const UrgentCare = () => {
  ...
  return (
    <div>
        ...
        <div style={{backgroundImage: `url(${Urgent_one})`}} className='bg-cover   md:h-48 h-60 w-full mt-44 flex flex-col  items-center justify-center'>
            <div className='absolute inset-0 bg-transparent/10 md:h-52 h-64 mt-[175px]'></div>
            <div className='relative flex flex-col items-center justify-center'>
                <p className='text-3xl text-white'><b>Urgent Care</b></p>
                <p className='text-xl text-white'>Convenient and Affordable</p>
            </div>
        </div>
        ...
        <div className='relative bg-center bg-cover bg-no-repeat min-h-screen pt-20 pb-20 w-full md:pl-14 pl-2   flex flex-col items-center justify-center' style={{backgroundImage: `url(${urgent_two})`, backgroundAttachment: "fixed" }}>
                            ...
                            <div className='relative flex flex-col gap-20'>
                              <div className='flex md:flex-row md:flex-wrap flex-col items-center justify-center gap-20'>
                               <div className='md:w-[450px] w-[350px] bg-[rgb(247,248,249)] px-4 py-4  shadow-md rounded-md shadow-black'>
                                 <h3 className='text-[rgb(12,113,195)] text-2xl font-bold pb-3'>Urgent Care</h3>
                                 <p className='text-[rgb(158,159,159)]'> Urgent care is a convenient affordable option when someone’s regular physician is unavailable or unable to offer a timely appointment or, when illness strikes outside of regular office hours. Urgent care also offers an alternative to waiting for hours in a hospital Emergency Room when your illness or injury in non-critical.</p>
                               </div>
