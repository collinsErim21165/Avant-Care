...
import weight from '../images/weight-loss.avif';
...
const Weight_loss = () => {
  ...
  return (
    <div>
        ...
        <div style={{backgroundImage: `url(${weight})`}} className='bg-center bg-cover bg-no-repeat md:h-48 h-60 w-full mt-44 flex flex-col  items-center justify-center'>
                    <div className='absolute inset-0 bg-transparent/10 md:h-52 h-64 mt-[175px]'></div>
                    <div className='relative flex flex-col items-center justify-center'>
                        <p className='text-3xl text-white'><b>Weight Loss</b></p>
                        <p className='text-xl text-white'>Tools for safe and effective weight loss</p>
                    </div>
          </div>
          ...
          <div className='relative bg-center bg-cover bg-no-repeat min-h-screen pt-20 pb-20 w-full md:pl-14 pl-2   flex flex-col items-center justify-center' style={{backgroundImage: `url(${weight})`, backgroundAttachment: "fixed" }}>
                                     ...
                                     <div className='relative flex flex-col gap-20'>
                                       <div className='flex md:flex-row md:flex-wrap flex-col items-center justify-center gap-20'>
                                        <div className='md:w-[450px] w-[350px] bg-[rgb(247,248,249)] px-4 py-4  shadow-md rounded-md shadow-black'>
                                          <h3 className='text-[rgb(12,113,195)] text-2xl font-bold pb-3'>Weight Loss</h3>
                                          <p className='text-[rgb(158,159,159)]'> Beaumont Urgent Care offers the most reliable tools for safe and effective weight loss through physical exams, medical testing, and prescription support. Our professionals will guide you to lose weight through safe, effective, easy to follow, and affordable diet plans that will help you maintain a healthy lifestyle. We provide specially formulated fat-burning injections to help you decrease fat deposits in your body, speed up your metabolism, and naturally reduce fat from the body.</p>
                                        </div>
